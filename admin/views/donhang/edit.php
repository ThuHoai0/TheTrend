                                    ...
                                    <form id="updateForm" action="?act=donhang/update&id=<?= htmlspecialchars($don_hang['id'] ?? '') ?>" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="trang_thai">
                                                ...
                                                <option value="16" <?= isset($don_hang['trang_thai_id']) && $don_hang['trang_thai_id'] == 16 ? 'selected' : '' ?>>Đơn hàng thành công</option>
                                                <option value="17" <?= isset($don_hang['trang_thai_id']) && $don_hang['trang_thai_id'] == 17 ? 'selected' : '' ?>>Đơn hàng thất bại</option>
                                                <option value="18" <?= isset($don_hang['trang_thai_id']) && $don_hang['trang_thai_id'] == 18 ? 'selected' : '' ?>>Đã hủy</option>
                                            </select>
