...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập Nhật Tin Tức | The Trend</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form id="updateForm" action="?act=tintuc/update&id=<?= $tin_tuc['id'] ?>" method="post">
<!--                                            <input type="hidden" name="id" value="--><?php //= $tin_tuc['id'] ?><!--">-->

                                            <div class="mb-3">
                                                <label for="citynameInput" class="form-label">Tiêu đề</label>
                                                <input type="text" class="form-control" placeholder="Nhập tiêu đề..." name="tieu_de" value="<?= $tin_tuc['tieu_de'] ?>">
