...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm Trạng Thái | The Trend</title>
                        ...
                        <div class="h-100">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h3 class="card-title mb-0 flex-grow-1">Thêm Trạng Thái</h3>
                                </div><!-- end card header -->
                                <form class="container-fluid mt-3 mb-3" action="?act=trangthaidonhang/store" method="post">
                                    <div class="mb-3">
                                        <h5 class="form-label">Tên trạng thái</h5>
