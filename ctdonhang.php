                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Tên:</strong> <?= htmlspecialchars($don_hang['name']) ?></p>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-end">
                                            <?php if ($don_hang['trang_thai_don_hang'] === 'Chờ xử lý' || 'Đã xác nhận' || 'Đang giao hàng' || 'Đã giao hàng'): ?>
                                                <!-- Button "Đã nhận hàng" -->
                                        ...
                                        <?php if ($don_hang['trang_thai_don_hang'] === 'Chờ xử lý'): ?>
