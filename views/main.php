        ...
        <div class="slick1">
            <?php if (!empty($banners)): ?>
                <?php foreach ($banners as $banner): ?>
                    <div class="item-slick1" style="background-image: url(<?= './admin/uploads/' . ($banner['duong_dan_hinh_anh'] ?? 'default.jpg'); ?>);">
                        <div class="container h-full">
                            <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                                <!-- Mô tả Banner -->
                                <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                                    <span class="ltext-101 cl2 respon2">
                                        <?= htmlspecialchars($banner['mo_ta'] ?? 'Mô tả mặc định'); ?>
                                    </span>
                                </div>
                                ...
                                <div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
                                    <h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
                                        <?= htmlspecialchars($banner['mo_ta'] ?? 'Tiêu đề mặc định'); ?>
                                    </h2>
                                </div>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="item-slick1" style="background-image: url('./admin/uploads/default.jpg');">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                                <span class="ltext-101 cl2 respon2">
                                    Không có banner hiển thị.
                                </span>
                            </div>
                        </div>
                    </div>
