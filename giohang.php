...
<!-- Shoping Cart -->
    <div class="container-fluid mt-5 mb-5">
                ...
                if (!isset($_SESSION['cart']) || empty($_SESSION['cart'])) {
                    ...
                    <form action="?act=updateCart" method="POST">
                        <div class="wrap-table-shopping-cart">
                            <table class="table-shopping-cart table table-bordered text-center align-middle mb-4 table-striped">
        ...
        <hr>
            <!--                 Thông tin đặt hàng-->
        <div class="col-12 col-lg-8 col-xl-7 m-lr-auto m-b-50 mb-4">
